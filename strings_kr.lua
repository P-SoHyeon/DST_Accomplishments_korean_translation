...
ACCOMPLISHMENTS =
{
    UI =
    {
        ...
        ANNOUNCE_TROPHY_FMT = "{who} 님이 도전과제 달성: ",

        -- For status announcement
        ANNOUNCE_TYPE =
        {
            TODO =
            {
                "{mouse_icon} 도전과제:  {trophy_name} 달성을 하고 싶어요.",
                -- "{mouse_icon} 도전과제: {trophy_name} 달성을 위한 도움이 필요해요.",
                -- "{mouse_icon} 도전과제: {trophy_name} 달성을 함께해요!",
            },
            DONE =
            {
                "{mouse_icon} 도전과제 '{trophy_name}' 달성",
            },
            WHEN_CYCLE =
            {
                "{mouse_icon} {when_cycle}에 도전과제 '{trophy_name} 달성",
            },
            WHEN_IRL =
            {
                "{mouse_icon} {when_irl}에 도전과제 '{trophy_name}' 달성",
            },
            LABEL =
            {
                "{mouse_icon} 도전과제 '{trophy_name}' 진행 상황: {record} {record_label}",
            },
            PREFAB_DONE =
            {
                "{mouse_icon} 도전과제 '{trophy_name}' 달성에 필요한 \"{prefab}\" 이미 있음",
            },
            PREFAB =
            {
                "{mouse_icon} 도전과제 '{trophy_name}' 달성에 \"{prefab}\" 필요",
            },
        },
        ...
        PANEL_SETTING =
        {
            ...
            ANNOUNEC_TROPHY = "달성 알림",
            ANNOUNEC_TROPHY_HOVER = "도전과제 달성 알림을 표시합니다",
    ...
    COMBAT =
    {
        ...
        WALRUSDART_TITLE = "눈에는 눈",
        WALRUSDART_DESC = "맥터스크를 다트로 처치",

        BRIGHTSHADESTAFF_TITLE = "별을 쏘다",
        BRIGHTSHADESTAFF_DESC = "빛말풀 지팡이로 생물 20마리 처치",

        SHADOWSCYTHE_TITLE = "어둠의 수확",
        SHADOWSCYTHE_DESC = "그림자 수확낫으로 생물 20마리 처치",
    },
    HUNT =
    {
        GENERIC_LABEL = "사냥",
    ...
    BOSS =
    {
        ...
        -- TOADSTOOLAXE_TITLE = "어째서 우린 아직도 살아있는 거지? 그저 고통받기 위해서?",
        -- TOADSTOOLAXE_DESC = "독꺼비버섯을 도끼로 처치",
        ...
        DAYWALKER_TITLE = "끊어진 사슬",
        DAYWALKER_DESC = "악몽화된 늑대돼지 처치",
    ...
    TIME =
    {
        ...
        POWCAKE_DESC = "수단 방법 가리지 않고 파우더케이크 썩게 하기",
        POWCAKE_LABEL = "썩힘",
    },
    EXPLORATION =
    {
        ...
        RIFTBIOME_TITLE = "저 너머의 침략자",
        RIFTBIOME_DESC = "지상에 생성된 수수께끼의 균열 발견",

        SHADOWRIFTBIOME_TITLE = "저 아래의 공포",
        SHADOWRIFTBIOME_DESC = "동굴에 생성된 수수께끼의 균열 발견",
    },
    FARMING =
    {
        SOWALL_TITLE = "파종기",
    ...
    CHARACTER =
    {
        WILSON1_TITLE = "선택받은 자",
        WILSON1_DESC = "윌슨으로 그림자의 권신 또는 월광의 혁신가 선택",
        WILSON2_TITLE = "비상식량",
        WILSON2_DESC = "윌슨으로 수염 안에 음식 보관",
        ...
        -- WICKERBOTTOM2_TITLE = "꿈나라로 갈 시간",
        -- WICKERBOTTOM2_DESC = "위커바텀으로 잠들기",
        ...
        WAXWELL1_TITLE = "악몽 추출",
        WAXWELL1_DESC = "맥스웰로 그림자 암습을 이용하여 악몽 연료 10개 획득",
        WAXWELL1_LABEL = "개 획득",
        WAXWELL2_TITLE = "교도관",
        WAXWELL2_DESC = "맥스웰로 그림자 감옥을 이용하여 생물 40마리 가두기",
        WAXWELL2_LABEL = "가둠",
        ...
        WONKEY1_TITLE = "나나! 나나!",
        WONKEY1_DESC = "웡키로 바나나 40개 섭취",
        WONKEY2_TITLE = "잭 도주기",
        WONKEY2_DESC = "웡키로 해적 반다나와 커틀리스를 장착하고 1분간 달리기",
    },
    ACTIVITY =
    {
        ...
        BEARGERVEST_TITLE = "동면기",
        BEARGERVEST_DESC = "겨울에 동면곰 조끼 착용",

        BRIGHTSHADE_TITLE = "빛말풀 전사",
        BRIGHTSHADE_DESC = "빛말풀 투구, 빛말풀 갑옷, 빛말풀 검을 동시에 착용",

        VOIDCLOTH_TITLE = "공허의 유산",
        VOIDCLOTH_DESC = "공허의 두건, 공허의 로브, 그림자 수확낫을 동시에 착용",
        ...
        LUNARFORGE_TITLE = "천상의 대장간",
        LUNARFORGE_DESC = "대황간 건설",

        SHADOWFORGE_TITLE = "가장 어두운 대장간",
        SHADOWFORGE_DESC = "암영술 제단 건설",

        EYETURRET_TITLE = "뚫리지 않는 방패",
        EYETURRET_DESC = "하운디우스 슈티우스 건설",

        FURNACE_TITLE = "뼛속까지 따뜻하게",
        FURNACE_DESC = "용비늘 화로 건설",

        MANNEQUIN_TITLE = "멋지고 우아하게",
        MANNEQUIN_DESC = "멋진 의상을 자랑할 마네킹 건설",

        DUMMYTARGET_TITLE = "동네북",
        DUMMYTARGET_DESC = "힘을 시험해볼 아무 종류의 동네북씨 건설",
        ...
        BUSHHAT_TITLE = "부시에서 대기",
        BUSHHAT_DESC = "덤불 모자를 사용하여 주변 환경에 녹아들게 위장",

        FIRESTAFFPIT_TITLE = "불춤꾼",
        FIRESTAFFPIT_DESC = "불꽃 지팡이로 화덕에 불 붙이기",

        INKED_TITLE = "이봐 징징이!",
        INKED_DESC = "얼굴에 날쌘징어의 먹물 묻히기",

        PERDFAN_TITLE = "명절에 태풍",
        PERDFAN_DESC = "행운의 부채로 어이없는 상황 연출",

        MEGAFLARE_TITLE = "오게 두어라",
        MEGAFLARE_DESC = "도발 조명탄으로 적을 불러 한판 붙기",

        WARDROBE_TITLE = "패션 주간",
        WARDROBE_DESC = "옷장에서 기분에 맞춰 새 옷으로 갈아입기",

        SHELLBLOCK_TITLE = "방어가 곧 공격",
        SHELLBLOCK_DESC = "스너틀 갑옷으로 공격 막기",

        FORESTSTALKER_TITLE = "숲지기",
        FORESTSTALKER_DESC = "되살아난 해골을 동굴 밖에서 소생",

        ANTLIONHAT_TITLE = "땅밟기",
        ANTLIONHAT_DESC = "땅엎기 투구로 바닥을 100회 뒤엎음",
        ANTLIONHAT_LABEL = "뒤엎음",

        MEETWAGSTAFF_TITLE = "비밀스러운 창립자",
        MEETWAGSTAFF_DESC = "로버트 와그스태프와 처음으로 조우",

        MEETCHARLIE_TITLE = "그림자 여왕",
        MEETCHARLIE_DESC = "찰리와 처음으로 조우",
    },
}
}
